...
public class PasswordResetTokenController {
	...
	public ResponseEntity<Map<String, String>> resetPasswordRequest(
			@RequestBody PasswordRequestUtil passwordRequestUtil, HttpServletRequest servletRequest)
		...
		String passwordResetUrl = passwordResetEmailLink(user.get(), getApplicationUrl(servletRequest),
				passwordResetToken);
	...
	private String passwordResetEmailLink(Users user, String applicationUrl, String passwordToken)
			throws MessagingException, UnsupportedEncodingException {
	...
	public ResponseEntity<Map<String, String>> changePassword(@RequestBody PasswordRequestUtil request) {
		...
		boolean isPasswordChanged = userManagementService.changePassword(user.get(), request.getOldPassword(),
