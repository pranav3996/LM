...
public class ReqRes {
	...
	public ReqRes(int statusCode, String error, String message, String accessToken, String refreshToken,
			String expirationAccessTokenTime, String expirationRefreshTokenTime, String firstName, String lastName,
			String city, String role, String email, String password, Users users, List<Users> usersList,
			boolean isAdmin) {
		super();
		this.statusCode = statusCode;
		this.error = error;
